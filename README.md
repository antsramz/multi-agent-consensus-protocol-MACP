# Multi-Agent Consensus Protocol (MACP)
A machine-only protocol for enabling autonomous agents to reach deterministic agreement on shared decisions or outputs.

---

## What this template does
MACP allows multiple agents to submit proposals, vote, tally results, and finalize a consensus outcome without human involvement.

---

## How it works
1. Agents submit proposals.  
2. Each agent votes using deterministic rules.  
3. Votes are tallied.  
4. A consensus result is produced in machine-readable form.
...
## Purpose
This is Template #6 of your 10‑template machine‑only collection.
